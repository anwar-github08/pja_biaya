...
<div class="konten">
   ...
   <div class="card">
      <div class="card-body">
         ...
         <form method="POST" id="form-jenis-biaya">
            <div class="input-group mb-3">
               <input type="text" name="jenis_biaya" class="form-control bg-light" id="jenis-biaya" placeholder="input baru.." required autocomplete="off">
         ...
         <div class="data-jenis-biaya"></div>
      </div>
   </div>
...
<script src="../aset/js/js_jenis_biaya.js"></script>